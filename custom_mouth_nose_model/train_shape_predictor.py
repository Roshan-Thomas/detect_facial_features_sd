...
# of 2^tree_depth leaves in each tree; small values of tree_pth
...
# more accurate, but slower; use large values if speed is not a problem,
# otherwise smaller values for resoure constrained/embedded devies
...
# the more *accuracte* your model will be 
...
# this value to the number of availabel cores on the system, but you
